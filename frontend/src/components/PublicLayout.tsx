    ...
    label: (
      <div style={{ padding: '12px 16px', minWidth: 250 }}>
        ...
        <a 
          ...
          style={{ color: '#10B981', fontSize: 16, fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 8 }}
        >
          ...
          <Space size={10}>
            ...
            >
              <Button 
                ...
                icon={<PhoneOutlined style={{ fontSize: 16, color: '#10B981' }} />}
                style={{
                  borderColor: '#10B981',
                  color: '#10B981',
                  fontWeight: 600,
                ...
                onMouseLeave={(e) => {
                  ...
                  const dropdown = e.currentTarget.querySelector('.anticon-down') as HTMLElement;
                  if (dropdown) dropdown.style.color = '#10B981';
                }}
              >
                <span style={{ color: '#10B981 !important' }}>🚨 Emergency</span> <DownOutlined style={{ fontSize: 12, marginLeft: 4, color: '#10B981 !important' }} />
              </Button>
            </Dropdown>
