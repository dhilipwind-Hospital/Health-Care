...
const WelcomeSection = styled.div`
  ...
  &::before {
    ...
    right: 0;
    height: 4px;
    background: linear-gradient(90deg, #10B981, #f06292, #10B981);
      ...
      <WelcomeSection>
        <div style={{ marginBottom: '24px' }}>
          <div style={{ 
            width: '64px', 
            height: '64px', 
            background: 'linear-gradient(135deg, #10B981, #f06292)',
            borderRadius: '50%',
            display: 'flex',
            alignItems: 'center',
          ...
          <Title level={1} style={{ marginBottom: '16px', color: '#262626', fontSize: '32px' }}>
            Welcome to <span style={{ color: '#10B981' }}>{organizationName}</span>
          </Title>
