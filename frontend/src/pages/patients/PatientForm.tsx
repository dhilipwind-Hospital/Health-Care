    ...
    <PatientFormContainer>
      ...
      <Card loading={loading}>
        ...
        >
          ...
          <Title level={5} style={{ marginTop: 24, marginBottom: 16 }}>India-Specific Information (Optional)</Title>
          <Row gutter={16}>
            <Col xs={24} md={6}>
              <Form.Item 
                name="aadhaarNumber" 
            ...
            <Col xs={24} md={6}>
              <Form.Item name="abhaId" label="ABHA ID">
                <Input placeholder="ABHA Health ID" maxLength={20} />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            ...
            <Col xs={24} md={6}>
              <Form.Item name="nationality" label="Nationality" initialValue="Indian">
                <Input placeholder="Nationality" />
              </Form.Item>
            </Col>
            <Col xs={24} md={12}>
              <Form.Item name="fatherOrSpouseName" label="Father's/Spouse's Name">
                <Input placeholder="Father's or Spouse's name" />
              </Form.Item>
            </Col>
          </Row>
