  ...
  return (
    <Page style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px 24px' }}>
        ...
        <div className="hero-inner">
          <div className="copy">
            <div style={{ display: 'inline-block', padding: '6px 16px', background: 'rgba(236, 64, 122, 0.1)', borderRadius: '20px', marginBottom: '12px' }}>
              <Text style={{ color: '#10B981', fontWeight: 600, fontSize: '14px' }}>🩺 Expert Medical Care</Text>
            </div>
      ...
      <div style={{ 
        ...
        <Typography.Text style={{ color: '#10B981', fontWeight: 600 }}>📊 Showing {pagedRows.length} of {displayRows.length} doctors</Typography.Text>
      </div>
      {generatedDept && (
        <Alert
          showIcon
