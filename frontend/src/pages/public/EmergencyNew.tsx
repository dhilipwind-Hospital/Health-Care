    ...
    <PageContainer>
      <ContentWrapper>
        ...
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} lg={10}>
            <InfoSection>
              <Title level={3} style={{ color: '#10B981', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <HotlineCard key={index}>
                    <div style={{ flex: 1 }}>
                      ...
                      <a 
                        ...
                        style={{ fontSize: 20, fontWeight: 700, color: '#10B981', textDecoration: 'none' }}
                      >
              ...
              <FeatureList>
                <FeatureItem>
                  <FeatureIcon style={{ background: '#EFF6FF', color: '#10B981' }}>
                    <ClockCircleOutlined />
                  </FeatureIcon>
                  <div>
...
const EmergencyButton = styled(Button)`
  ...
  &:hover {
    background: linear-gradient(135deg, #059669 0%, #c2185b 100%) !important;
    transform: translateY(-2px);
