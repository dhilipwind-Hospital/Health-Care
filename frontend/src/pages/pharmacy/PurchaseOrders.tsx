...
import { PlusOutlined, EyeOutlined, CheckOutlined, InboxOutlined, ArrowLeftOutlined } from '@ant-design/icons';
...
const PurchaseOrders: React.FC = () => {
  ...
  const loadMedicines = async () => {
    try {
      ...
      setMedicines(res.data.medicines || res.data.data || res.data || []);
    } catch (error) {
          ...
          <>
            <Descriptions column={2} bordered size="small">
              ...
              <Descriptions.Item label="Total Amount">
                ${Number(detailsModal.totalAmount || 0).toFixed(2)}
              </Descriptions.Item>
