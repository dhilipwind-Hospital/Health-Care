  ...
  const fetchPrescriptions = async () => {
    try {
      ...
      if (activeTab === 'pending') {
        ...
        apiEndpoint = '/pharmacy/prescriptions/all?status=dispensed'; // Filter by status using new endpoint
      } else if (activeTab === 'partially_dispensed') {
        apiEndpoint = '/pharmacy/prescriptions/all?status=partially_dispensed'; // Filter by status using new endpoint
      }
