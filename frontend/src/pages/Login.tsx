...
const Login: React.FC = () => {
  ...
  return (
    <LoginContainer>
      ...
      <LeftPane>
        <Board>
          <StyledTitle level={3} style={{ textAlign: 'center', marginBottom: 8 }}>Welcome to Ayphen Care</StyledTitle>
          <Typography.Text style={{ display: 'block', marginBottom: 24, color: '#64748b', textAlign: 'center' }}>Access your health records, book appointments, and manage your healthcare</Typography.Text>
