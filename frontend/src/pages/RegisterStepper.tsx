        ...
        return (
          <>
            ...
            >
              <Checkbox>
                I agree to the{' '}
                <a href="/terms" target="_blank" style={{ color: '#10B981' }}>
                  Terms & Conditions
                </a>
              </Checkbox>
            </StyledFormItem>
            ...
            >
              <Checkbox>
                I agree to the{' '}
                <a href="/privacy" target="_blank" style={{ color: '#10B981' }}>
                  Privacy Policy
                </a>
              </Checkbox>
            </StyledFormItem>
      ...
      <Modal>
        ...
        <div style={{ textAlign: 'center', marginTop: 24 }}>
          <Text style={{ color: '#666', fontSize: '15px' }}>
            ...
            <a 
              onClick={() => navigate('/login')} 
              style={{ color: '#10B981', fontWeight: 600, cursor: 'pointer', textDecoration: 'none' }}
            >
              Login
            </a>
          </Text>
