  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <div style={{ marginBottom: '32px', textAlign: 'center' }}>
        <Title level={1} style={{ color: '#10B981', marginBottom: '8px' }}>
      ...
      <Row gutter={16} style={{ marginBottom: '32px' }}>
        <Col span={6}>
          <Card>
            ...
            />
            <Progress percent={completionPercentage} strokeColor="#10B981" />
          </Card>
        </Col>
        <Col span={6}>
          <Card>
                      ...
                      <Avatar 
                        ...
                        style={{ 
                          backgroundColor: 
                            ...
                            task.status === 'in-progress' ? '#10B981' :
                            '#d9d9d9'
                        }}
                      />
                    }
          ...
          {inheritedFeatures.map((category, index) => (
            <Col span={6} key={index}>
              <Card 
                ...
                style={{ height: '100%' }}
                headStyle={{ backgroundColor: '#EFF6FF', color: '#10B981' }}
              >
                <List
                  size="small"
      ...
      {/* Call to Action */}
      <Card style={{ marginTop: '24px', textAlign: 'center', background: 'linear-gradient(135deg, #EFF6FF 0%, #ffffff 100%)' }}>
