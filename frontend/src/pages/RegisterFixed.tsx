...
import { Form, Input, Button, Typography, Checkbox, Steps, Radio, App, Select } from 'antd';
import {
  MailOutlined,
  LockOutlined,
  PhoneOutlined,
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0:
        return (
          <>
            ...
            >
              <Select size="large" placeholder="Select your country" style={{ height: 52, borderRadius: 12 }}>
      ...
      case 2:
        return (
          <>
            <Title level={4} style={{ marginBottom: '24px', color: '#10B981' }}>
              Review & Confirm
            </Title>
            ...
            >
              <Checkbox>
                I agree to the <a href="/terms" style={{ color: '#10B981' }}>Terms & Conditions</a> and <a href="/privacy" style={{ color: '#10B981' }}>Privacy Policy</a>
              </Checkbox>
            </Form.Item>
          </>
        );
    ...
    <PageContainer>
      <Modal>
        ...
        <div style={{ textAlign: 'center', marginTop: '24px' }}>
          <Text>
            Already have an account? <a href="/login" style={{ color: '#10B981', fontWeight: 500 }}>Sign in</a>
          </Text>
        </div>
      </Modal>
    </PageContainer>
