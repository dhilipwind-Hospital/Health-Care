      ...
      if (response.data?.success && response.data?.data) {
        ...
        const transformedOrgs = response.data.data.map((org: any) => {
          ...
          return {
            ...
            users: org.userCount || org.users || 0,
  ...
  const columns = [
    {
      ...
      render: (text: string, record: Organization) => (
        <div>
          <div style={{ fontWeight: 600, color: '#10B981' }}>{text}</div>
    ...
    },
    {
      ...
      render: (count: number) => (
        <Tag color={count > 0 ? 'blue' : 'default'}>
          {count || 0} {(count || 0) === 1 ? 'Branch' : 'Branches'}
        </Tag>
      ),
    },
    {
  ...
  const handleModalOk = async () => {
    try {
      ...
      if (editingOrg) {
        ...
        try {
          const response = await api.post('/organizations/all', values);
          ...
          <div style={{ padding: '16px 0' }}>
              ...
              <Col span={12}>
                <Card size="small" style={{ height: '100%' }}>
                  <div style={{ textAlign: 'center' }}>
                    <BankOutlined style={{ fontSize: '24px', color: '#10B981', marginBottom: '8px' }} />
                    ...
                    <Tag
                      color={
                        viewingOrg.plan === 'Basic' ? '#52c41a' :
                          viewingOrg.plan === 'Professional' ? '#10B981' : '#722ed1'
                      }
            ...
            <Row gutter={[24, 16]} style={{ marginTop: '16px' }}>
              ...
              <Col span={8}>
                <Card size="small" style={{ height: '100%' }}>
                  <div style={{ textAlign: 'center' }}>
                    <DollarOutlined style={{ fontSize: '20px', color: '#10B981', marginBottom: '8px' }} />
            ...
            <Card
              title={
                <span>
                  <MailOutlined style={{ marginRight: '8px', color: '#10B981' }} />
                  Contact Information
                </span>
              }
              size="small"
            ...
            <Card
              title={
                <span>
                  <UserOutlined style={{ marginRight: '8px', color: '#10B981' }} />
                  Usage Statistics
                </span>
              }
              size="small"
            ...
            <Card
              title={
                <span>
                  <EditOutlined style={{ marginRight: '8px', color: '#10B981' }} />
                  Quick Actions
                </span>
              }
              size="small"
