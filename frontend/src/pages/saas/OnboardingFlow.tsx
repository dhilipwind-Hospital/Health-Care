            ...
            {Object.entries(planFeatures).map(([plan, details]) => (
              <Col span={8} key={plan}>
                <Card 
                  ...
                  style={{ 
                    border: onboardingData.selectedPlan === plan ? '2px solid #10B981' : '1px solid #d9d9d9',
                    cursor: 'pointer'
                  }}
                >
                  <div style={{ textAlign: 'center', marginBottom: 16 }}>
                    <Title level={4} style={{ color: '#10B981' }}>{plan}</Title>
                    <Title level={2}>
        ...
        <div style={{ textAlign: 'right' }}>
          <Space>
            ...
            {currentStep < steps.length - 1 && (
              <Button type="primary" onClick={next} style={{ background: '#10B981', borderColor: '#10B981' }}>
                Next
              </Button>
            )}
            {currentStep === steps.length - 1 && (
              <Button type="primary" onClick={handleFinish} style={{ background: '#10B981', borderColor: '#10B981' }}>
