...
const TelemedicineHub: React.FC = () => {
  ...
  const sessionColumns = [
    {
      ...
      render: (record: TelemedicineSession) => (
        <div>
          <div style={{ fontWeight: 600, color: '#10B981' }}>{record.sessionId}</div>
  ...
  const todaySessions = sessions.filter(s => s.appointmentDate === new Date().toISOString().split('T')[0]).length;
    ...
    <div style={{ padding: '24px' }}>
              ...
              <Col span={8}>
                <Card size="small" title="Camera Test">
                  <div style={{ textAlign: 'center', padding: '20px' }}>
                    ...
                    <Button
                      type="primary"
                      style={{ marginTop: '8px', background: '#10B981', borderColor: '#10B981' }}
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="notes" type="primary" style={{ background: '#10B981', borderColor: '#10B981' }} onClick={() => handleAddNotes()}>
            Add Notes
          </Button>
        ]}
      >
          ...
          <div>
            ...
            <Card size="small" title="Video Conference">
              <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                  <VideoCameraOutlined style={{ fontSize: '64px', color: '#10B981', marginBottom: '16px' }} />
