        ...
        <Col span={6}>
          <Card>
            <div style={{ textAlign: 'center' }}>
              <PlayCircleOutlined style={{ fontSize: '32px', color: '#10B981', marginBottom: '8px' }} />
              ...
              <Card title="Training Materials">
                <List
                  ...
                  renderItem={(resource) => (
                    ...
                    >
                      <List.Item.Meta
                        avatar={<Avatar icon={resource.icon} style={{ backgroundColor: '#10B981' }} />}
              ...
              <Card title="Training Statistics" style={{ marginTop: '16px' }}>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ marginBottom: '16px' }}>
                    <div style={{ fontSize: '32px', fontWeight: 600, color: '#10B981' }}>95%</div>
