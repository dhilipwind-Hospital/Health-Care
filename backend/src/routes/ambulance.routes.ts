...
// Moved GET /:id to the bottom to avoid route collision with specific paths like /notifications
...
// Get ambulance by ID (Moved to bottom to allow specific routes like /notifications to match first)
