...
export class MedicineController {
  ...
  static createMedicine = async (req: Request, res: Response) => {
    try {
      ...
      if (bodyData.manufactureDate && typeof bodyData.manufactureDate === 'string') {
        bodyData.manufactureDate = new Date(bodyData.manufactureDate);
      }
      if (bodyData.expiryDate && typeof bodyData.expiryDate === 'string') {
