...
(async () => {
  try {
    ...
    if (!org) {
      console.error('No organization found. Cannot seed pharmacy.');
      process.exit(1);
    }
    const orgId = org.id;
